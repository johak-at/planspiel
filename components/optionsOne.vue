...
<template>
    <div v-if="totalRoundCount===0" class="card w-[40rem] shadow-xl bg-white">
    ...
    <div v-else-if="totalRoundCount===1" class="card w-[40rem] shadow-xl bg-white">
        <div class="card-body space-y-3">
    ...
    <div v-else-if="totalRoundCount===2" class="card w-[40rem] shadow-xl bg-white">
        <div class="card-body space-y-3">
