...
<template>
    <div class="h-screen flex">
      <div class="flex-1 flex items-center justify-center bg-[#f1f1f1]">
        <form @submit.prevent="signIn" class="flex flex-col px-16 py-8 rounded-md shadow-lg max-w-screen-sm w-full bg-white">
          ...
          <div class="flex items-center justify-center mt-4 text-black">
            <p class="text-sm text-black font-semibold">Don't have an account? <a href="http://localhost:3000/register" class="text-black font-bold  hover:text-blue-600">Register</a></p>
          </div>
        </form>
      </div>
    </div>
