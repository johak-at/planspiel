  ...
  <div class="h-screen flex">
    <div class="flex-1 flex items-center justify-center bg-[#f1f1f1]">
      ...
      >
        ...
        <div
          v-if="successMsg"
          class="bg-green-200 p-2 rounded-md text-green-700 mb-4"
        >
          {{ successMsg }}
        </div>
        ...
        <div
          v-if="errorMsg"
          class="bg-red-200 p-2 rounded-md text-red-700 mb-4"
        >
          {{ errorMsg }}
        </div>
        ...
        <button
          type="submit"
          class="bg-blue-500 text-white font-semibold py-2 rounded-md hover:bg-blue-600 w-20"
        >
          Sign in
        </button>
        ...
        <div class="flex items-center justify-center mt-4 text-black">
          <p class="text-sm text-black font-semibold">
            ...
            <a href="/register" class="text-black font-bold hover:text-blue-600"
              >Register</a
            >
          </p>
        </div>
